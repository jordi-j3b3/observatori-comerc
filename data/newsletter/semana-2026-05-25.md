...
**Mercadona integra a su proveedor logístico Logifruit, que creció un 7,7%**
*Prensa económica, 22 de mayo*
...
3. **Mercadona integra a Logifruit (su proveedor logístico)** — Hecho público (compra de Logifruit por Mercadona, +7,7%), recopilado el 2026-05-22. Titular **parafraseado con palabras propias**, no se reproduce literal. La fuente original se retiró de la recopilación por su reserva de minería de datos; el hecho es público y se atribuye genéricamente (§12 de la línea editorial).
